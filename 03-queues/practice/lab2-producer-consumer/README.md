...
|-------|-----------|-----------|----------|----------|---------|------------|
| 1 | 3 | 2 |120 |115 |5 |95.8 |
| 2 | 4 | 2 |170 |140 |30 |82.3 |
| 3 | 3 | 1 |140 |100 |40 |71.4 |

### คำถามสำหรับการทดลอง
1. ในทดลองที่ 2 เกิดอะไรขึ้นกับ Queue?
- ตอนเพิ่มผู้ผลิตเป็น 4 คน แต่ยังมีผู้บริโภคแค่ 2 คน ทำให้สินค้าถูกผลิตเร็วเกินไปจน Queue รับไม่ทันผลคือ Queue จะเต็มบ่อยมาก และมีสินค้าที่ถูก drop เพราะส่งเข้า Queue ไม่ได้ ใน Serial Monitor จะเห็นข้อความ Queue full! และบางครั้ง Load Balancer ก็จะเตือนว่า ⚠️ HIGH LOAD DETECTED!

2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
- พอลองลดผู้บริโภคเหลือแค่ 1 คน ระบบจะเริ่มช้าและค้างบ่อยขึ้น เพราะ Consumer ต้องทำงานหนักมาก Producer ทั้งสามคนจะผลิตสินค้าเร็วกว่า Consumer ประมวลผลทัน ทำให้สินค้าค้างใน Queue เยอะมากและถูก drop จำนวนมาก ระบบมีประสิทธิภาพลดลงอย่างเห็นได้ชัด 

3. Load Balancer แจ้งเตือนเมื่อไหร่?
- Load Balancer จะคอยเช็กจำนวนสินค้าที่อยู่ใน Queue ทุก ๆ 1 วินาที ถ้าจำนวนสินค้าใน Queue มากกว่า 8 ชิ้น มันจะเตือนว่า ⚠️ HIGH LOAD DETECTED! และไฟ LED ทุกดวงจะกระพริบ แปลว่าตอนนั้นระบบเริ่มมีโหลดสูงเกินไป ควรเพิ่ม Consumer หรือลดความเร็วในการผลิต
